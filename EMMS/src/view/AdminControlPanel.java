...
public class AdminControlPanel extends JFrame {
	...
	protected void loadStudents(DefaultTableModel model) {
		...
		if (students != null && !students.isEmpty()) {
			...
			model.addRow(new Object[]{1, "MUKAMA", "REGINE", "Regine", "F", "2004-05-01"});
			model.addRow(new Object[]{2, "SEZERANO", "Delice", "Delice", "F", "2001-08-22"});
			model.addRow(new Object[]{3, "TWIZEYIMANA", "Onesphore", "Onesphore", "M", "1999-12-10"});
	...
	private void loadInstructors(DefaultTableModel model) {
		...
		if (instructors != null && !instructors.isEmpty()) {
			...
			// Add sample data for demonstration
			model.addRow(new Object[]{1, "Dr. BUGINGO Emmanuel", "INS001", "Active","BATIMA A", "bugingo@gmail.com", 101});
			model.addRow(new Object[]{2, "Dr. KAJUKA Iddrissa", "INS002", "Active", "MAMBA B", "kayijuka@gmail.com", 102});
			model.addRow(new Object[]{3, "Dr. BATAMURIZA Jenitha", "INS003", "On Leave", "MAMBA A", "batamuriza@gmail.com", 103});
		}
	}
	...
	private void loadCourses(DefaultTableModel model) {
		...
		if (courses != null && !courses.isEmpty()) {
			...
			// Add sample data for demonstration
			model.addRow(new Object[]{101, " Programming with java", "CS101", "2024-01-15"});
