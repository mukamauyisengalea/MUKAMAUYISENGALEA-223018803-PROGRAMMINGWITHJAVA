...
public class GradeManagementButton extends AbstractAdminButton {
	...
	private static JPanel createViewGradesPanel() {
		...
		JButton editGradeButton = new JButton("✏️ Edit Grade");
		JButton deleteGradeButton = new JButton("🗑️ Delete Grade");
	...
	private static JPanel createTranscriptsPanel() {
		...
		// Action buttons
		JPanel actionPanel = new JPanel(new FlowLayout());
		JButton generateButton = new JButton("🖨️ Generate Transcript");
	...
	public static void main(String[] args) {
		...
		// Also test the dialog directly
		// gradeButton.showGradeManagementDialog();
	}
}